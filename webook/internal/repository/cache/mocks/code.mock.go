...
// Source: ./webook/internal/repository/cache/code.go
//
...
func (m *MockCodeCache) Verify(ctx context.Context, biz, phone, inCode string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Verify", ctx, biz, phone, inCode)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCodeCacheMockRecorder) Verify(ctx, biz, phone, inCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Verify", reflect.TypeOf((*MockCodeCache)(nil).Verify), ctx, biz, phone, inCode)
}
