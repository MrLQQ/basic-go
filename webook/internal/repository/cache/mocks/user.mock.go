...
func (m *MockUserCache) Get(ctx context.Context, userId string) (domain.UserProfile, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserCache) Set(ctx context.Context, du domain.UserProfile) error {
	m.ctrl.T.Helper()
