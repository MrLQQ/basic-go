...
func (m *MockUserRepository) Edit(ctx context.Context, profile domain.UserProfile) error {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Profile(ctx context.Context, profile domain.UserProfile) (domain.UserProfile, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Profile", ctx, profile)
...
func (mr *MockUserRepositoryMockRecorder) Profile(ctx, profile any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Profile", reflect.TypeOf((*MockUserRepository)(nil).Profile), ctx, profile)
}
