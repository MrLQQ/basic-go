...
func (m *MockCodeRepository) Verify(ctx context.Context, biz, phone, inCode string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCodeRepositoryMockRecorder) Verify(ctx, biz, phone, inCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Verify", reflect.TypeOf((*MockCodeRepository)(nil).Verify), ctx, biz, phone, inCode)
}
