...
//
//	mockgen -source ./webook/internal/service/user.go -package=svcmocks -destination=./webook/insternal/service/mocks/user.mock.go
//
...
func (m *MockUserService) Edit(ctx context.Context, userProfile domain.UserProfile) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Edit", ctx, userProfile)
	ret0, _ := ret[0].(error)
	return ret0
}

// Edit indicates an expected call of Edit.
func (mr *MockUserServiceMockRecorder) Edit(ctx, userProfile any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Edit", reflect.TypeOf((*MockUserService)(nil).Edit), ctx, userProfile)
}
...
func (m *MockUserService) Profile(ctx context.Context, userProfile domain.UserProfile) (domain.UserProfile, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) Profile(ctx, userProfile any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Profile", reflect.TypeOf((*MockUserService)(nil).Profile), ctx, userProfile)
}
